...
public class PocongActivity extends Activity {
	//deklarasi variabel
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_pocong);
...
//cek jawaban (method)
	public void  cekJawaban(View v){
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent(getApplicationContext(), JudikaActivity.class);
			startActivity(i);
		}
		else{
			//pesan text
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.pocong, menu);
		return true;
	}
