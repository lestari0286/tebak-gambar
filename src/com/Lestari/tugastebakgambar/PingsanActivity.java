...
public class PingsanActivity extends Activity {
	//deklarasi variabel
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_pingsan);
	...
	public void  cekJawaban(View v){
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent(getApplicationContext(), PocongActivity.class);
			startActivity(i);
		}
		else{
			//pesan text
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.pingsan, menu);
		return true;
	}
