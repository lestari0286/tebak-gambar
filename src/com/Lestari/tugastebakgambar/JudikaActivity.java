...
public class JudikaActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_judika);
...
public void  cekJawaban(View v){
	...
	if(jawabanUser.equals(jawabanBenar)){
		...
		Intent i = new Intent(getApplicationContext(), KunciInggrisActivity.class);
		startActivity(i);
	}
	else{
		//pesan text
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.judika, menu);
		return true;
	}
