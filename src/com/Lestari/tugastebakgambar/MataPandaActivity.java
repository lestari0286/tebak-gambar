...
public class MataPandaActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_mata_panda);
...
public void  cekJawaban(View v){
	...
	if(jawabanUser.equals(jawabanBenar)){
		...
		Intent i = new Intent(getApplicationContext(), DemamPanggungActivity.class);
		startActivity(i);
	}
	else{
		//pesan text
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.mata_panda, menu);
		return true;
	}
