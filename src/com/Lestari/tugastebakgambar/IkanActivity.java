...
public class IkanActivity extends Activity {
	//deklarasi variabel
	EditText jawabanTXT;
...
//cek jawaban (method)
	public void  cekJawaban(View v){
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent(getApplicationContext(), SrikayaActivity.class);
			startActivity(i);
		}
		else{
			//pesan text
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.ikan, menu);
		return true;
	}
